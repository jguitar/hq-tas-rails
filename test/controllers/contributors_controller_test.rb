...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { building_id: @contributor.building_id, business_unit_id: @contributor.business_unit_id, code: @contributor.code, first_name: @contributor.first_name, surname: @contributor.surname, workplace_id: @contributor.workplace_id, workroom_id: @contributor.workroom_id } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { building_id: @contributor.building_id, business_unit_id: @contributor.business_unit_id, code: @contributor.code, first_name: @contributor.first_name, surname: @contributor.surname, workplace_id: @contributor.workplace_id, workroom_id: @contributor.workroom_id } }
