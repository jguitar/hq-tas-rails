...
class BuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post buildings_url, params: { building: { code: @building.code, name: @building.name, site_id: @building.site_id } }
    end
  ...
  test "should update building" do
    patch building_url(@building), params: { building: { code: @building.code, name: @building.name, site_id: @building.site_id } }
